...
module lab7_soc_mm_interconnect_0 (
	...
	wire          cmd_mux_006_src_valid;                                                              // cmd_mux_006:src_valid -> accul_reset_s1_agent:cp_valid
	wire  [106:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> accul_reset_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                              // accul_reset_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire    [8:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> accul_reset_s1_agent:cp_channel
	wire          cmd_mux_006_src_startofpacket;                                                      // cmd_mux_006:src_startofpacket -> accul_reset_s1_agent:cp_startofpacket
	wire          cmd_mux_006_src_endofpacket;                                                        // cmd_mux_006:src_endofpacket -> accul_reset_s1_agent:cp_endofpacket
	...
	wire          accul_reset_s1_agent_rp_valid;                                                      // accul_reset_s1_agent:rp_valid -> router_008:sink_valid
	wire  [106:0] accul_reset_s1_agent_rp_data;                                                       // accul_reset_s1_agent:rp_data -> router_008:sink_data
	wire          accul_reset_s1_agent_rp_ready;                                                      // router_008:sink_ready -> accul_reset_s1_agent:rp_ready
	wire          accul_reset_s1_agent_rp_startofpacket;                                              // accul_reset_s1_agent:rp_startofpacket -> router_008:sink_startofpacket
	wire          accul_reset_s1_agent_rp_endofpacket;                                                // accul_reset_s1_agent:rp_endofpacket -> router_008:sink_endofpacket
	...
	wire          accul_reset_s1_agent_rdata_fifo_src_valid;                                          // accul_reset_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_006:in_0_valid
	wire   [33:0] accul_reset_s1_agent_rdata_fifo_src_data;                                           // accul_reset_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_006:in_0_data
	wire          accul_reset_s1_agent_rdata_fifo_src_ready;                                          // avalon_st_adapter_006:in_0_ready -> accul_reset_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_006_out_0_valid;                                                  // avalon_st_adapter_006:out_0_valid -> accul_reset_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_006_out_0_data;                                                   // avalon_st_adapter_006:out_0_data -> accul_reset_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_006_out_0_ready;                                                  // accul_reset_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_006:out_0_ready
	wire    [0:0] avalon_st_adapter_006_out_0_error;                                                  // avalon_st_adapter_006:out_0_error -> accul_reset_s1_agent:rdata_fifo_sink_error
